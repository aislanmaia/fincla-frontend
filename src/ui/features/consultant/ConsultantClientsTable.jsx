...
import { fmtLastActive, fmtMoney, healthTone, trendGlyph } from "./ConsultantClientCard";
...
function Row({ client, onOpenClient }) {
  ...
  return (
    <tr>
      ...
      <td style={{ ...NUMTD, color: client.savings_pct < 0 ? T.red : T.ink }}>{client.savings_pct.toFixed(1)}%</td>
      <td style={{ ...NUMTD, color: client.debt_pct >= 50 ? T.red : T.ink }}>{client.debt_pct.toFixed(1)}%</td>
