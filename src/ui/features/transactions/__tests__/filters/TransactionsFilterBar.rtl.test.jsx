...
describe("<TransactionsFilterBar>", { timeout: 15000 }, () => {
  ...
  it("período personalizado exibe intervalo amigável no facet card", async () => {
    ...
    /* Não existe chip "Personalizado" — ele caiu no protótipo fechado.
       Com todo preset preenchendo os campos e o calendário, "nenhum chip aceso"
       já diz que o intervalo é próprio, e os campos logo abaixo dizem qual é.
       Um chip que só acende, sem fazer nada ao ser clicado, é um controle a mais
       para explicar e nenhum a mais para usar. */
