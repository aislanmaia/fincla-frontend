...
export const InvoiceStatusCard: React.FC<InvoiceStatusCardProps> = ({
    ...
    const getStatusColor = (status: string, isOverdue?: boolean) => {
        if (isOverdue) return 'text-red-700 bg-red-100 dark:bg-red-900/40 dark:text-red-300 font-semibold';
        switch (status) {
            case 'open': return 'text-blue-700 bg-blue-100 dark:bg-blue-900/40 dark:text-blue-300 font-semibold';
            case 'closed': return 'text-slate-700 bg-slate-100 dark:bg-slate-800 dark:text-slate-300 font-semibold';
            case 'paid': return 'text-green-700 bg-green-100 dark:bg-green-900/40 dark:text-green-300 font-semibold';
            default: return 'text-slate-700 bg-slate-100 dark:bg-slate-800 dark:text-slate-300 font-semibold';
        }
    };
